...
def parse_args():
    ...
    parser.add_argument("--patience", type=int, default=500, help="Early-stopping patience (epochs without val improvement).")
...
if __name__ == "__main__":
    ...
    make_val_mask_from_train(data, val_frac=args.val_frac, seed=33)
